...
<tr>
	<td><label for="abstractTitle">Abstract Title:</label></td>
	<td><input type="text" name="abstractTitle"/></td>
</tr>
<tr>
	<td><label for="conferenceName">Conference Name:</label></td>
	<td><input type="text" name="conferenceName"/></td>
</tr>
<tr>

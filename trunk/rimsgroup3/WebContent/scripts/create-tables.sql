...
MASSEY_FIRST_NAME	VARCHAR(30) CHARACTER SET utf8	NOT NULL ,
MASSEY_LAST_NAME	VARCHAR(30) CHARACTER SET utf8	NOT NULL ,
MASSEY_MIDDLE_NAME	VARCHAR(30)	CHARACTER SET utf8		,
TYPE				VARCHAR(15)         ,
...
MISC_ID				VARCHAR(20)			,
MISC_FIRST_NAME		VARCHAR(30)	CHARACTER SET utf8 NOT NULL ,
MISC_LAST_NAME		VARCHAR(30)	CHARACTER SET utf8 NOT NULL ,
MISC_MIDDLE_NAME	VARCHAR(30)			CHARACTER SET utf8,
